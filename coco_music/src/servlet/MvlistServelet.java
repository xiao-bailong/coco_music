 ...
 *
 */
public class MvlistServelet extends HttpServlet {
    ...
    private MvlistDao mvlistdao = new MvlistDao();
...
//        }
        ...
        if("GetMvListData".equals(method)){
            getMvListData(request,response);
            return;
        }
...
//        }
    ...
    private void getMvListData(HttpServletRequest request,
                                           HttpServletResponse response) {
        // TODO Auto-generated method stub
        Page<Mvlist> page = new Page<Mvlist>(1, 999);
        page = mvlistdao.findList(page);
