...
public class BookCategoryServlet extends HttpServlet {
	...
	private UniversityCategoryDao bookCategoryDao = new UniversityCategoryDao();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if("toBookCategoryListView".equals(method)){
			request.getRequestDispatcher("/WEB-INF/views/university_category.jsp").forward(request, response);
			return;
		}
	...
	private void getBookCategoryList(HttpServletRequest request,
		...
		Page<UniversityCategory> page = new Page<UniversityCategory>(pageNumber, pageSize);
