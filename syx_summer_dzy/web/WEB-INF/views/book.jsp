	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'name',title:'高校名称',width:150},
 		        {field:'universityCategory',title:'高校类别',width:100,
 		        	formatter: function(value,row,index){
 		        		if(value != null && value != 'undefined')
 		        			return value.name;
 		        	}	
 		        },
 		       {field:'rank',title:'校友会排名',width:80},
 		       {field:'province',title:'所在省会',width:100},
 		      {field:'address',title:'所在地址',width:200},
...
// 	    });
	    ...
	    $("#editDialog").dialog({
			...
			onBeforeOpen: function(){
				...
				$("#edit_rank").textbox('setValue', selectRow.rank);
// 				$("#edit_address").textbox('setValue', selectRow.address);
				$("#edit_address").val(selectRow.address);
				$("#edit-id").val(selectRow.id);
				$("#edit_book_category").combobox('setValue', selectRow.universityCategory.id);
...
// 			],
			onBeforeOpen: function(){
				var selectRow = $("#dataList").datagrid("getSelected");
				//设置值
				$("#check_name").textbox('setValue', selectRow.name);
				$("#check_province").textbox('setValue', selectRow.province);
				$("#check_rank").textbox('setValue', selectRow.rank);
// // 				$("#edit_address").textbox('setValue', selectRow.address);
				$("#check_address").val(selectRow.address);
 				$("#check-id").val(selectRow.id);
 				$("#check_book_category").combobox('setValue',selectRow.universityCategory.id);
// // 				$("#edit_status").textbox('setValue', selectRow.status);
// // 				$("#edit_number").numberbox('setValue', selectRow.number);
				$("#check_info").val(selectRow.info);
			}
	    });
...
// 	    });
	  	...
	  	$("#search-btn").click(function(){
	  		$('#dataList').datagrid('load',{
	  			...
	  			universityCategoryId:$("#search-book-category").textbox('getValue')
	  		});
	  	});
	  
	  //下拉框通用属性
	  	$("#add_book_category, #search-book-category,#edit_book_category,#check_book_category").combobox({
	  		width: "200",
	  		height: "auto",
	  		valueField: "id",
	  		textField: "name",
	...
	<div id="addDialog" style="padding: 10px">
		<form id="addForm" method="post">
			<table cellpadding="8">
				...
				<tr>
					<td>高校校友会排名:</td>
					<td><input id="add_rank" style="width: 200px; height: 30px;"
						class="easyui-textbox" type="text" name="rank"
						data-options="required:true, missingMessage:'请填写高校校友会排名'" /></td>
				</tr>
				<tr>
					<td>高校省会:</td>
					<td><input id="add_province" style="width: 200px; height: 30px;"
						class="easyui-textbox" type="text" name="province"
						data-options="required:true, missingMessage:'请填写高校所在省会'" /></td>
				</tr>
				<tr>
					<td>高校地址:</td>
					<td><textarea id="add_address"
							style="width: 300px; height: 80px;" name="address"></textarea></td>
				</tr>
<!-- 				<tr> -->
<!-- 					<td>高校地址:</td> -->
	...
	<div id="editDialog" style="padding: 10px">
		<form id="editForm" method="post">
			...
			<table cellpadding="8">
				...
				<tr>
					<td>高校分类:</td>
					<td><input id="edit_book_category"
						style="width: 200px; height: 30px;" class="easyui-textbox"
						type="text" name="universityCategoryId"
						data-options="required:true, missingMessage:'请填写高校名称'" /></td>
				</tr>
				<tr>
					<td>高校校友会排名:</td>
					<td><input id="edit_rank" style="width: 200px; height: 30px;"
						class="easyui-textbox" type="text" name="rank"
						data-options="required:true, missingMessage:'请填写高校校友会排名'" /></td>
				</tr>
				<tr>
					<td>高校省会:</td>
					<td><input id="edit_province" style="width: 200px; height: 30px;"
						class="easyui-textbox" type="text" name="province"
						data-options="required:true, missingMessage:'请填写高校所在省会'" /></td>
				</tr>
<!-- 				<tr> -->
<!-- 					<td>高校介绍:</td> -->
<!-- 					<td><textarea id="edit_address" -->
<!-- 							style="width: 300px; height: 140px;" name="address"></textarea></td> -->
<!-- 				</tr> -->
				<tr>
					<td>高校地址:</td>
					<td><textarea id="edit_address"
	...
	<div id="checkDialog" style="padding: 10px">
		<form id="checkForm" method="post">
			...
			<table cellpadding="8">
				<tr>
					<td>高校名称:</td>
					<td><input id="check_name" style="width: 200px; height: 30px;"
						class="easyui-textbox" type="text" readonly="readonly" name="name"
						data-options="required:true, missingMessage:'请填写高校名称'" /></td>
				</tr>
				<tr>
					<td>高校分类:</td>
					<td><input id="check_book_category"
						style="width: 200px; height: 30px;" class="easyui-textbox"
						type="text" readonly="readonly" name="universityCategoryId"
						data-options="required:true, missingMessage:'请填写高校名称'" /></td>
				</tr>
				<tr>
					<td>高校校友会排名:</td>
					<td><input id="check_rank" style="width: 200px; height: 30px;"
						class="easyui-textbox" type="text" readonly="readonly" name="rank"
						data-options="required:true, missingMessage:'请填写高校校友会排名'" /></td>
				</tr>
				<tr>
					<td>高校省会:</td>
					<td><input id="check_province" style="width: 200px; height: 30px;"
						class="easyui-textbox" type="text" readonly="readonly"  name="province"
						data-options="required:true, missingMessage:'请填写高校所在省会'" /></td>
				</tr>
<!-- 				<tr> -->
<!-- 					<td>高校介绍:</td> -->
...
<!-- 				</tr> -->
				<tr>
					<td>高校地址:</td>
					<td><textarea id="check_address"
							style="width: 300px; height: 80px;" readonly="readonly" name="address"></textarea></td>
				</tr>

				<tr>
					<td>高校介绍:</td>
					<td><textarea id="check_info"
							style="width: 300px; height: 140px;"readonly="readonly"  name="info"></textarea></td>
				</tr>
