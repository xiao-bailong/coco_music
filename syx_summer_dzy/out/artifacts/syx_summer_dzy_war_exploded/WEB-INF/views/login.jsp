...
<title>登录|三位一体管理系统</title>
<meta name="keywords" content="三位一体系统">
</head>
<body>

	<div class="header" style="padding: 0;">
		<h2
			style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">三位一体管理系统</h2>
	</div>
				...
				<div class="row cl">
					<div class="formControls col-8 col-offset-3">
						<input class="input-text size-L" name="vcode" id="vcode"
							...
							src="CpachaServlet?method=GetLoginVCode&vl=4&w=155&h=40">
					</div>
				</div>
				...
				<div class="row">
					<div class="formControls col-8 col-offset-3">
						<input id="submitBtn" type="button"
							...
							value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;"> <a
							href="LoginServlet?method=registe"
	...
	<div class="footer">Copyright &nbsp; @ sunyuxuan</div>
