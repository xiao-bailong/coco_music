...
<body>
	...
	<div id="toolbar">
		<div style="float: left;">
			<a id="return-btn" href="javascript:;" class="easyui-linkbutton"
				data-options="iconCls:'icon-edit',plain:true">归还</a>
		</div>
		<div style="float: left;" class="datagrid-btn-separator"></div>
		<div style="margin-left: 10px;">
			用户名称：<input id="search-username" class="easyui-textbox" /> 图书名称：<input
				id="search-book-name" class="easyui-textbox" /> 借阅状态：<select
				class="easyui-combobox" style="width: 100px;" id="search-status">
	...
	<div id="returnDialog" style="padding: 10px">
		<form id="returnForm" method="post">
			...
			<table cellpadding="8">
				...
				<tr>
					<td>归还数量:</td>
					<td><input id="real_return_number" name="realReturnNumber"
						style="width: 200px; height: 30px;" class="easyui-numberbox"
						type="text"
						data-options="min:1,precision:0,required:true, missingMessage:'请填写归还数量'" /></td>
				</tr>
			</table>
		</form>
	</div>
