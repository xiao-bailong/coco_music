...
<script type="text/javascript">
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"RecommandServlet?method=BookCategoryList&t="+new Date().getTime(),
	        idField:'id', 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'univname',title:'高校名称',width:200},
 		        {field:'majorname',title:'专业名称',width:150},
 		       {field:'rate',title:'推荐指数',width:150},
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "删除高校分类前请确保该高校分类没有借阅信息，否则可能会导致借阅功能异常，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "SubjectCategoryServlet?method=DeleteBookCategory",
							data: {ids: ids},
							dataType:'json',
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "RecommandServlet?method=addProperty&t="+new Date().getTime(),
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "SubjectCategoryServlet?method=EditBookCategory&t="+new Date().getTime(),
	...
	<div id="toolbar">
		<div style="float: left;">
				<a id="add" href="javascript:;" class="easyui-linkbutton"
					data-options="iconCls:'icon-add',plain:true">开始推荐</a>
		</div>
